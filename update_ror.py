...
# NOTE: The following functions are duplicated from s2aff/util/s3.py
# This is intentional - update_ror.py runs independently of s2aff.
# If you modify these functions, also update s2aff/util/s3.py
